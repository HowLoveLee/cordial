"""
Django settings for cordialproject project.
...
ROOT_URLCONF = 'cordialproject.urls'
...
WSGI_APPLICATION = 'cordialproject.wsgi.application'
...
STATIC_URL = '/static/'
STATIC_ROOT = BASE_DIR / "static"  # This is where Django will collect static files for production
